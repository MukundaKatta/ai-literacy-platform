// ai-literacy-platform — main entry point
...
export function getStatus(): Record<string, unknown> {
  return { service: "ai-literacy-platform", version: VERSION, ready: true };
}

if (process.argv[1] && import.meta.url === `file://${process.argv[1]}`) {
  console.log(`ai-literacy-platform v${VERSION}`);
